...
pub struct TrayState {
    ...
    pub last_blur_hide_ms: AtomicU64,
}
...
mod tests {
    use super::{
        should_skip_blur_hide, tray_left_click_action, unix_now_ms, validate_shell_safe,
        TrayLeftClickAction, TRAY_CLICK_CLOSE_GRACE_MS, TRAY_SHOW_BLUR_GRACE_MS,
    };
